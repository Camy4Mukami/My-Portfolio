    ...
    <div id="contact" className="w-full px-[12%] py-10 scroll-mt-20 bg-[url('/footer-bg-color.png')] bg-no-repeat bg-[length:90%_auto]">
      ...
      <form onSubmit={onSubmit} className='max-w-2xl mx-auto'>
        <div className='grid grid-cols-auto gap-6 mt-10 mb-8'>
            <input type="text" placeholder='Enter your name' required  className='flex-1 p-3 otline-none border-[0.5px] border-gray-400 rounded-md bg-white' name='name'/>
            <input type="Email" placeholder='Enter your email' required  className='flex-1 p-3 otline-none border-[0.5px] border-gray-400 rounded-md bg-white' name='email' />
        </div>
        <textarea name="message"  rows={6} placeholder='Type your message here....' required  className='w-full p-4 otline-none border-[0.5px] border-gray-400 rounded-md bg-white mb-6'></textarea>
